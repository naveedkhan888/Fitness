		...
		<div class="blog-details-content">	
	        ...
	        if (!empty($gallery_images)) : ?>
	            <div class="postbox-gallery mb-30">
	                ...
	                foreach( $gallery_images as $key => $image ) :   
	                	$image_url = wp_get_attachment_image_src($key, 'xtremefitness-main-blog', true);
	                	?>
	                    <img src="<?php echo esc_url($image_url[0]); ?>" alt="<?php print esc_attr__('image','xtremefitness'); ?>" />
	                <?php 
	                endforeach; ?>
	            </div>
	        <?php 
				...
				<?php
					the_content( sprintf(
						wp_kses(
							...
							__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'xtremefitness' ),
							array(
								'span' => array(
									'class' => array(),
								),
			...
			if( has_category() ): ?>
				<div class="blog-details_bottom">
					<?php $xtremefitness_tg->categories(); ?>
				</div>	
			<?php 
			endif; ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="blog-item">
			...
			<div class="blog-details">
				...
				<div class="blog-btn">
				    <a class="read-more-btn" href="<?php esc_url( the_permalink() );?>"><?php esc_html_e("Read More", "xtremefitness");?><i class="fa fa-long-arrow-right"></i></a>
				</div>
